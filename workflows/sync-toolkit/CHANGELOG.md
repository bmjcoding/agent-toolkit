...
- Replaced Claude-specific argument metadata and placeholder usage with a
  portable `## Inputs` contract for sync flags and component scoping.

## [4.3.0] - 2026-04-28

### Changed

- Updated component examples and changed-file grouping guidance for open-ended
  categorized shared skill paths under `skills/<category>/.../<slug>/`.
