...
agent wrappers, hook registry assets, bundles, configuration templates, and Codex-specific
rule composition assets. Canonical agent bodies, workflow bodies, skills, rules, and
shared hook logic live at the repo root.
