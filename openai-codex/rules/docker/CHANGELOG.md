...
- BREAKING: copied to `openai-codex/rules/docker/` as part of the v3.0 multi-tool restructure.
...
[Unreleased]: https://github.com/bmjcoding/agent-toolkit/compare/openai-codex/docker-v3.0.0...HEAD
[3.0.0]: https://github.com/bmjcoding/agent-toolkit/tree/openai-codex/docker-v3.0.0
