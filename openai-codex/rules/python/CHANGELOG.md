...
- BREAKING: copied to `openai-codex/rules/python/` as part of the v3.0 multi-tool restructure.
...
[Unreleased]: https://github.com/bmjcoding/agent-toolkit/compare/openai-codex/python-v3.0.0...HEAD
[3.0.0]: https://github.com/bmjcoding/agent-toolkit/tree/openai-codex/python-v3.0.0
