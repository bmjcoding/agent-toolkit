...
- Renamed self-improvement validation references to `definition-review` in
  retro follow-up dispatch guidance.
...
- Removed the redundant Claude-specific changelog copy from `claude-code/agents/frankenstein/CHANGELOG.md`.
