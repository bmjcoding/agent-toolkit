...
`AGENTS.md` is the primary shared instruction surface. Root `CLAUDE.md` is kept only as
the one-line Claude compatibility shim `@AGENTS.md` and should not be treated as
Copilot's canonical shared instruction file.
