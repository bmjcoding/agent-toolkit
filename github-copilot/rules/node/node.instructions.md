---
description: "Node.js dependency management: pin exact versions for production deps, protect lockfiles."
applyTo: "**/*.{ts,tsx,js,jsx,mjs,cjs},**/package.json,**/package-lock.json,**/pnpm-lock.yaml,**/yarn.lock"
---
