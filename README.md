...
**Columns**: `# | status | severity | environment | file | item | deferred_reason | source | finding_id | phase | added_at | session_id`

**Status values**: `open`, `deferred-env`, `deferred-session`, `blocked`, `resolved`, `wont-fix`
