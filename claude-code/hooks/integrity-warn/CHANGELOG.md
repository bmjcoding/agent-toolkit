...
- BREAKING: v3.0 layout — hooks remain under `claude-code/hooks/integrity-warn/`; skill/rule path patterns in some scripts updated to new `claude-code/skills/` and `claude-code/rules/` locations.
...
- BREAKING: moved to the agent-toolkit multi-tool layout. Files relocated:
  - `hooks/integrity-warn/` → `claude-code/hooks/integrity-warn/`
...
[1.0.0]: https://github.com/bmjcoding/agent-toolkit/tree/integrity-warn-v1.0.0
