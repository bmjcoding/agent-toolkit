...
- BREAKING: v3.0 layout — hooks remain under `claude-code/hooks/integrity-warn/`; historical skill/rule path patterns in some scripts were updated for the then-current layout.
