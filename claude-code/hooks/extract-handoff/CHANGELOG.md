...
- BREAKING: v3.0 layout — hooks remain under `claude-code/hooks/extract-handoff/`; skill/rule path patterns in some scripts updated to new `claude-code/skills/` and `claude-code/rules/` locations.
