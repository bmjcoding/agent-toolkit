...
- BREAKING: v3.0 layout — hooks remain under `claude-code/hooks/toolkit-edit-reminder/`; historical skill/rule path patterns in some scripts were updated for the then-current layout.
...
[1.0.0]: https://github.com/bmjcoding/agent-toolkit/tree/claude-code/toolkit-edit-reminder-v1.0.0
