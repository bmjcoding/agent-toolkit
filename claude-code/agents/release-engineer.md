...
touched changelog in scope:

1. Identify the touched `CHANGELOG.md` files in scope.
2. Load the `changelog` skill.
3. If a touched changelog's `## [Unreleased]` section is non-empty and this run will
