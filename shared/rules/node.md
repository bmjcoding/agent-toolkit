...
Tool-agnostic directives for Node.js / JavaScript / TypeScript projects.

> Claude Code specialization: `claude-code/rules/node/node.md` (includes lockfile policy that defers to Claude-specific config).
