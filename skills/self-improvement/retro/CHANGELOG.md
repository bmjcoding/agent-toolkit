...
- Updated retro helper script references to locate the retro skill through the
  categorized shared skill layout.
- Renamed definition quality-gate references and the self-improvement overview
  diagram to `definition-review`.
